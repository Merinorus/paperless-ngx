...
def test_preprocess_content(mock_stop_words):
    ...
    # Note: "doing" is stemmed to "do", which is a stop word. However, stop words are checked before stemming
    # Therefore, "do" is not removed from the preprocessed content.
