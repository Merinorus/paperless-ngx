...
def match_correspondents(document: Document, classifier: DocumentClassifier, user=None):
    pred_id = (
        classifier.predict_correspondent(document.content_for_classifier)
        if classifier
        else None
    )
...
def match_document_types(document: Document, classifier: DocumentClassifier, user=None):
    pred_id = (
        classifier.predict_document_type(document.content_for_classifier)
        if classifier
        else None
    )
...
def match_tags(document: Document, classifier: DocumentClassifier, user=None):
    predicted_tag_ids = (
        classifier.predict_tags(document.content_for_classifier) if classifier else []
    )
...
def match_storage_paths(document: Document, classifier: DocumentClassifier, user=None):
    pred_id = (
        classifier.predict_storage_path(document.content_for_classifier)
        if classifier
        else None
    )
